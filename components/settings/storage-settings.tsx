            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="space-y-2 pl-4">
                  <div className="flex items-center">
                    <input type="checkbox" id="mobile-photos" className="mr-2" checked />
                  ...
                  <div className="flex items-center">
                    <input type="checkbox" id="mobile-documents" className="mr-2" checked />
              ...
              <div>
                ...
                <div className="space-y-2 pl-4">
                  <div className="flex items-center">
                    <input type="checkbox" id="wifi-photos" className="mr-2" checked />
                    <label htmlFor="wifi-photos" className="text-gray-900 dark:text-gray-100">
                      Photos
                    </label>
                  </div>
                  <div className="flex items-center">
                    <input type="checkbox" id="wifi-audio" className="mr-2" checked />
                    <label htmlFor="wifi-audio" className="text-gray-900 dark:text-gray-100">
                      Audio
                    </label>
                  </div>
                  <div className="flex items-center">
                    <input type="checkbox" id="wifi-videos" className="mr-2" checked />
                    <label htmlFor="wifi-videos" className="text-gray-900 dark:text-gray-100">
                      Videos
                    </label>
                  </div>
                  <div className="flex items-center">
                    <input type="checkbox" id="wifi-documents" className="mr-2" checked />
