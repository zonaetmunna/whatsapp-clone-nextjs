  ...
  return (
    <div className="flex flex-col h-full">
      <div className="p-4 bg-[#f0f2f5] dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center md:hidden">
        ...
        <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100 ml-4">Account</h1>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        <div className="space-y-6 max-w-md mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
            <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Two-step verification</h4>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
            <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Change Number</h4>
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-2">
              Change your phone number and transfer your account information.
            </p>
            <Button variant="outline" className="w-full">
              Change
            </Button>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
            <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Request Account Info</h4>
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-2">
              Request a report of your account information and settings.
            </p>
            <Button variant="outline" className="w-full">
              Request
            </Button>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
            <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Delete My Account</h4>
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-2">
